...
export const authApi = {
  ...
  startSelfMfaEnrollment: (payload) => apiClient.post('/auth/mfa/enrollment/self/start', payload),
  confirmSelfMfaEnrollment: (payload) => apiClient.post('/auth/mfa/enrollment/self/confirm', payload),
