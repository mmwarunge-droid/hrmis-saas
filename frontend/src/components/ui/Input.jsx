    ...
    <div className="block space-y-1.5">
      ...
      <span className="relative block">
        ...
        <input
          ...
          className={`min-h-10 w-full rounded-lg border bg-white px-3 py-2 text-sm text-slate-900 shadow-sm outline-none transition placeholder:text-slate-400 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-500 ${
            Icon ? 'pl-9' : ''
          } ${
            error
