...
export default function UserProvisionForm({
  onSubmit,
  loading = false,
  isSuperAdmin = false,
  tenants = [],
    ...
    <form onSubmit={submit} className="space-y-6">
      ...
      <section className="rounded-xl border border-slate-100 bg-slate-50/70 p-5">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-slate-950">User identity</h3>
      ...
      {isEmployeeAccount && (
        <section className="rounded-xl border border-slate-100 bg-white p-5 shadow-sm">
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-slate-950">Employee profile</h3>
              <p className="text-xs text-slate-500">
                Creates a new employee record in the same transaction. For an
                existing employee, use Provision access from their employee page.
              </p>
            </div>
          </div>
          <div className="grid gap-4 md:grid-cols-2">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-lg border border-blue-100 bg-blue-50/70 px-4 py-3">
        <p className="flex max-w-2xl items-start gap-2 text-xs leading-5 text-blue-900">
